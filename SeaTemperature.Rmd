...
To make sure the analysis is transparent and can be recreated by anyone, a **public repository** named [**"SeaTemperature"**](https://github.com/eaTaki/SeaTemperature) has been set up on **GitHub** \<[https://github.com/eaTaki/SeaTemperature](http://127.0.0.1:24511/#0 "https://github.com/eaTaki/SeaTemperature")\>. This repository is a central open-source storage space and the organization of its contents can be found in the README file under said repository.
